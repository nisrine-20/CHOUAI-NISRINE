...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2024 at 07:13 AM
...
-- Updating the date to the current date (example date: '2024-05-17 19:05:09')
INSERT INTO `tbladmin` (`ID`, `AdminName`, `UserName`, `MobileNumber`, `Email`, `Password`, `AdminRegdate`) VALUES
(1, 'Admin', 'admin', 600000000, 'adminuser@example.com', 'f925916e2754e5e03f75dd58a5733251', CURRENT_TIMESTAMP);
...
-- Keeping only Fatima Zahra's information
...
(1, 1, '794994267', '1995-03-15', 'Female', 'Fatima Zahra', 'Casablanca', 'Ahmed Benjelloun', 'Amina Benjelloun', '123 Rue de Marrakech, Casablanca', '123 Rue de Marrakech, Casablanca', 650000001, 'fatima.zahra@example.com', CURRENT_TIMESTAMP, 'Application approved.', 'Verified', CURRENT_TIMESTAMP);
...
-- Keeping only Fatima Zahra's user entry
INSERT INTO `tbluser` (`ID`, `FirstName`, `LastName`, `MobileNumber`, `Address`, `Password`, `RegDate`) VALUES
(1, 'Fatima', 'Zahra', 650000001, '123 Rue de Marrakech, Casablanca', 'f925916e2754e5e03f75dd58a5733251', CURRENT_TIMESTAMP);
