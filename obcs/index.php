...
<head>
    ...
    <title>Home Page - Système en ligne de gestion des certificats de naissance</title>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php">N.S</a>
                    ...
                    <div class="col-12 h-100">
                        <div class="copywrite-content h-100 d-flex align-items-center justify-content-between">
                            ...
                            <div class="copywrite-text">
                                ...
                                Système en ligne de gestion des certificats de naissance
